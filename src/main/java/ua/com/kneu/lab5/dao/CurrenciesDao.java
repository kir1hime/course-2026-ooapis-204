...
public class CurrenciesDao extends BaseDao<Currencies> {

    public CurrenciesDao(SessionFactory sessionFactory) {
    ...
    public void save(Currencies obj) {
      ...
      /*  transactionExecutor.execute(entityManager ->
                entityManager.createQuery("INSERT INTO Currencies (currency) SELECT :currency")
    ...
    public void delete(Currencies obj) {
        transactionExecutor.execute(entityManager ->
                entityManager.createNativeQuery("DELETE FROM `currencies` WHERE id = ?")
